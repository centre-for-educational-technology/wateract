    ...
    <div class="max-w-7xl mx-auto lg:py-10 sm:px-6 lg:px-8">
        <div class="p-5 sm:p-10 bg-white overflow-hidden shadow-xl sm:rounded-lg">
            ...
            <div>
                ...
                <h2 class="mt-0">Kuidas esitada kogutud andmed?</h2>
                <div>
            ...
            <div>
                ...
                <div>
                    ...
                    <div class="my-3">
                        Maapinnalt tehtud fotoseire on kiire, lihtne ja tõhus viis looduses pigem aeglaselt toimuvate muutuste tuvastamiseks. Pidevalt jäädvustatud fotodest moodustub väärtuslik andmebaas. Fotoseire võib jagada kaheks peamiseks suunaks:
                        Võrdlusfotode tegemine - fotot kasutatakse üldiseks võrdluseks varem jäädvustatud seisundiga või mõne muutliku parameetri (nt veetaseme) hindamiseks. Foto ei pea olema tehtud täpselt samast asukohast eelmistega, vaid kirjeldama olusid üldiselt ja erinevate nurkade alt;
                        Kordusfotode tegemine - muutuste tuvastamiseks tehakse uusi pilte täpselt samast asukohast. Värskemate fotode võrdlemine vanematega annab ülevaate muutuste kulgemise kiirusest ja suunast, fotod näitavad muutuseid maastikus, taimestikus, kaldajoones, inimmõjus jne.
                    </div>
                    <div class="my-3">
            ...
            <div>
                ...
                <div>
                    <div>
                        ...
                        <div class="mb-3">
                            Allikavee iseloomustamiseks ilma analüütiliste instrumentideta sobivad hästi inimese enda meeled - hinda temperatuuri oma käega, nuusuta vett, maitse seda ja kirjelda, mida tunned.
                        </div>
                        <div class="my-3">
                            <span class="font-bold">Temperatuuri</span> määramiseks katsu vett. Kas see on õhutemperatuurist märgatavalt erinev?
                        </div>
                        ...
                        <div class="my-3">
                            Kirjelda <span class="font-bold">vee värvi ja hägusust</span> - kas see on selge või mudane, on see arusaadavalt värvunud vms. Kui sul on kaasas mõni läbipaistev ja värvitu anum, näiteks pudel, siis on värvi parem määrata, kui täidad anuma veega ja hoiad seda valge paberilehe ees.
                        </div>
                    </div>
                    <div class="mt-6">
                        <h3 class="font-bold">Kuidas mõõta allikavee kvaliteeti?</h3>
                        <div>
                            <div class="mb-3">
                            Allikavee kvaliteedi seire eesmärgiks võib olla nii ajalise kui ruumilise ülevaate saamine. Selleks, et saada esinduslikku ülevaadet ühe allika veekvaliteedi muutustest ajas, tuleks veeproove võtta ja neid analüüsida igakuiselt, kuid mitte harvem kui kvartaalselt (4x aastas). Mingi piirkonna üldisest allikavee kvaliteedist ülevaate saamiseks piisaks ka ühest veeproovist võimalikult paljudest erinevatest allikatest.
                            </div>
                            <div class="my-3">
            ...
            <div>
                ...
                <div>
                    ...
                    <div>
                        Allika äravoolu (vooluhulga) mõõtmine on vajalik selleks, et mõista paremini hüdrogeoloogilisi protsesse, koostada hüdroloogilisi prognoose ja/või hinnata põhjaveevarude kasutatavust. See kõik on vajalik põhjaveest sõltuvate ökosüsteemide säilitamiseks ning  inimestele vee kättesaadavuse tagamiseks. Kuna allikatest väljavoolava vee kogus on aastaajalisel muutuv, on põhjaveekihtide toite- ja väljumisala dünaamikast üksikasjaliku ülevaate saamiseks vaja teha mõõtmisi mitu korda aasta jooksul.
                    </div>
                    <div class="mt-3">
