<template>
    <div class="mx-2 sm:mx-8">
        <div v-if="$page.flash.success && show" class="w-full bg-green-100 border border-green-400 mt-8 flex items-center justify-between bg-green rounded">
            <div class="flex items-center">
                ...
                <div class="py-4 text-green-500 text-sm font-medium">{{ $page.flash.success }}</div>
            </div>
